  ...
  return (
    <div className="bridge-error">
      <div>
        ...
        <p>
          Abre la app con <code>scripts/macos/start.command</code>, <code>scripts\windows\start.bat</code> o <code>npm run dev</code>. Si
          estás viendo esto dentro de Electron, cierra la ventana y vuelve a iniciar.
        </p>
      </div>
    </div>
  );
